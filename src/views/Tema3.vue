...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-lg-6.position-relative
        ul.lista-ul--color.bgr_7.cfc_border.px-5.py-4
          ...
          li
            i.fas.fa-check.bgr_8
            | Manejo ambiental.
        img(src='@/assets/curso/temas/tema3/2.svg', alt='Texto que describa la imagen').pst_5.d-none.d-md-flex  
    ...
    .row
      .col-lg-4.mb-5
        .tarjeta-avatar
          img(src='@/assets/curso/temas/tema3/10.svg' alt='AvatarTop')
          .tarjeta.bgr_5
            .p-4
      ...
      .col-lg-6
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/tema3/11.svg' alt='AvatarTop')
        ...
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/tema3/12.svg' alt='AvatarTop')
          .tarjeta.bgr_3.align-content-center
            .p-2
        ...
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/tema3/13.svg' alt='AvatarTop')
          .tarjeta.bgr_3.align-content-center
            .p-2
